(function () {
  ...
  var removeTagButtons = document.getElementsByClassName(
    "Upsert-removeTagButton"
  );
  var ul = document.getElementById("Upsert-tagList");
  var submitButton = document.getElementById("Upsert-submit");
  var deleteButton = document.getElementById("Upsert-delete");
  ...
  deleteButton.addEventListener("click", function (e) {
    ...
    if (result) {
      ...
      fetch(`/article/${id}`, {
        ...
        window.location.href = "/articles/upsert";
      });
    }
  });
