        ...
        let idDropdown =
            ...
            :: (upsertDocument.ExistingIds
                ...
                |> Seq.map (fun (id, title) ->
                    let attrs =
                        if title = upsertDocument.Title then
                            _selected :: [ _value (id.ToString()) ]
                        else
                            [ _value (id.ToString()) ]
            ...
            form [
                ...
                div [ _class "Upsert-inputRow" ] [
                    ...
                    input [
                        ...
                        _id "ArticleDate"
                        _name "ArticleDate"
                        _value (upsertDocument.ArticleDate.ToString("yyyy-MM-dd"))
                    ]
                ]
                div [ _class "Upsert-inputRow" ] [
                    label [
                ...
                div [ _class "Upsert-inputRow" ] [
                    ...
                    input [
                        ...
                        _id "Description"
                        _name "Description"
                        _value upsertDocument.Description
                    ]
                ]
                div [ _class "Upsert-inputRow" ] [
                    label [
                             ...
                             li [ _class "Upsert-tagListItem" ] [
                                 div [ _class "Upsert-tagValue" ] [
                                     input [
                                         _type "text"
                                         _name "Tags"
                                         _class "Upsert-tagName"
                                         _value t
                                     ]
                                     input [
                                         _type "button"
                                         _class "Upsert-removeTagButton"
                                         _value "-"
                                     ]
                                 ]
                             ]))
